...
=== Request
include::{snippets}/study/add-member/curl-request.adoc[]

=== RequestBody
include::{snippets}/study/add-member/request-body.adoc[]

=== Response
include::{snippets}/study/add-member/http-response.adoc[]

=== ResponseBody
include::{snippets}/study/add-member/response-body.adoc[]
