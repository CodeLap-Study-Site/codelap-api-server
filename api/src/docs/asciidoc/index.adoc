...
== 유저가 참가한 스터디 리스트 조회 API

=== Request
include::{snippets}/user/findStudyList/curl-request.adoc[]

=== RequestBody
include::{snippets}/user/findStudyList/request-body.adoc[]

=== Response
include::{snippets}/user/findStudyList/http-response.adoc[]

=== ResponseBody
include::{snippets}/user/findStudyList/response-body.adoc[]