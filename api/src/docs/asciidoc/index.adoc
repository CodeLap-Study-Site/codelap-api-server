...
=== Request
include::{snippets}/study-view/create/curl-request.adoc[]

=== RequestBody
include::{snippets}/study-view/create/request-body.adoc[]

=== Response
include::{snippets}/study-view/create/http-response.adoc[]

=== ResponseBody
include::{snippets}/study-view/create/response-body.adoc[]