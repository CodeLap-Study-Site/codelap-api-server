...
=== Request
include::{snippets}/study/remove/curl-request.adoc[]

=== RequestBody
include::{snippets}/study/remove/request-body.adoc[]

=== Response
include::{snippets}/study/remove/http-response.adoc[]

=== ResponseBody
include::{snippets}/study/remove/response-body.adoc[]
